...
function WPPB_RepeaterField( repeaterFieldHTML ){
    ...
    var limitRules = jQuery.parseJSON( _this.uiObject.attr( DATA_RPF_LIMIT_RULES ) );
    var generalLimit = parseInt( _this.uiObject.attr( DATA_RPF_GENERAL_LIMIT ) );
    var pmsSubscriptions = jQuery.parseJSON( _this.uiObject.attr( DATA_RPF_PMS_ROLE_SUBSCRIPTION_IDS ) );
