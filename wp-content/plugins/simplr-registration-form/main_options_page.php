...
<div class="wrap simplr_settings">

	<div class="simplr_icon">
		<img src="<?php echo SIMPLR_URL; ?>/assets/images/sign-up-48.png" >
	</div>
	<h1><?php _e('Registration Form Settings','simplr-registration-form'); ?></h1>
