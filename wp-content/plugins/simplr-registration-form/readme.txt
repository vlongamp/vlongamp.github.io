...
1. Download `simplr-registration-form.zip` and upload contents to the `/wp-content/plugins/` directory.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Insert forms using the TinyMCE registration button on your post/page.
...
Translations can be added very easily through [GlotPress](https://translate.wordpress.org/projects/wp-plugins/simplr-registration-form).
...
= 2.4.4 =
* 2016-07-01
* Uses new simplr_role_lock to ensure role cannot be escalated. Addresses vulnerability reported here: https://www.pluginvulnerabilities.com/2016/06/21/privilege-escalation-vulnerability-in-simplr-registration-form-plus/
